...
Note that the versions of `simpleservice`, such as `0.4.0`, used in the following refer to the tags used in the respective [Docker images](https://hub.docker.com/r/gajjelli/simpleservice/tags/) created. There are no tags or releases as such in this GitHub repo.
...
See also the [container images](https://hub.docker.com/r/gajjelli/simpleservice/tags/).
